...
export type GetCollectionNftsQuery = { __typename?: 'query_root', current_token_datas_v2: Array<{ __typename?: 'current_token_datas_v2', description: string, token_name: string, token_data_id: string, token_uri: string, decimals?: any | null }> };
